...
NEWLINE=$'\n'
PS1=' %B%f󰣛%f%b %B%f%n%f%b $(dir_icon)  %B%f%~%f%b${vcs_info_msg_0_} %(?.%B%F{green}✓%f%b.%F{red}✗)%f%b $NEWLINE %f%f '
#  ┌─┐┬  ┬ ┬┌─┐┬┌┐┌┌─┐
#  ├─┘│  │ ││ ┬││││└─┐
#  ┴  ┴─┘└─┘└─┘┴┘└┘└─┘
...
# pnpm end
export PATH_TO_FX=$HOME/javafx-sdk-17/javafx-sdk-17.0.17/lib
